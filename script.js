...
btnLike.addEventListener("click", () => {
  window.open("https://www.youtube.com/watch?v=uPThTZeSLCc", "_blank");
...
btnComment.addEventListener("click", () => {
  window.open("https://www.youtube.com/watch?v=wj7nErSgLfk&lc=1", "_blank");
...
btnUnlock.addEventListener("click", () => {
  ...
  const countdownInterval = setInterval(() => {
    ...
    if (timeLeft <= 0) {
      ...
      setTimeout(() => {
        window.location.href = "https://www.mediafire.com/file/6zxfqvsj2j03p7b/Plants-Vs-Zombies-2-by-ViVienDoChannel.zip/file";
      }, 1000);
    }
  }, 1000);
});
